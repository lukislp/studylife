...
{
    /// <summary>Server-observed transition false-&gt;true on TimerStateService.SaveAsync. Cannot
    ...
    /// <summary>Server-observed transition true-&gt;false on TimerStateService.SaveAsync - covers
    ...
    /// <summary>Fired at the same point SessionService.CheckNewRecordAsync already sends its
    ...
    /// <summary>CourseGoalService.SaveAsync is an upsert (PUT) - Created/Updated distinguish
    ...
    /// <summary>StudyProgramService.SetCompletedAsync toggles a purely manual flag both ways -
    ...
    /// <summary>ExamPlanService.GenerateAsync bulk-inserts StudySessionEntity rows
