...
| [studylife-telegram](https://github.com/lukislp/studylife-telegram) | Telegram bot: start/pause/stop the timer, today/agenda, quick notes, session-event and reminder messages | Dynamic OAuth client, one key per chat (PKCE); receives events as a studylife-webhooks subscriber | No (timer, sessions, notes) |
